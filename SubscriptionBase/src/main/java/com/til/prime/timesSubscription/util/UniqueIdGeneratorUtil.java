...
import com.til.prime.timesSubscription.constants.BaseConstants;
...
public class UniqueIdGeneratorUtil {
    ...
    public static final String generateOrderId(){
        return generateUniqueIdInConsecutiveSimilarCharactersPattern(BaseConstants.ORDER_ID_LENGTH, null);
    }

    public static final String generatePrimeId(){
        return generateUniqueIdInConsecutiveSimilarCharactersPattern(BaseConstants.PRIME_ID_LENGTH, null);
    }
