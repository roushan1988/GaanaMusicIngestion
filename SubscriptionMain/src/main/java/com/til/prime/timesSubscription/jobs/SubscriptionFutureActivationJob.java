            ...
            while(true) {
                ...
                for (UserSubscriptionModel userSubscriptionModel : userSubscriptions) {
                    try {
                        ...
                        userSubscriptionModel.setPlanStatus(PlanStatusHelper.getPlanStatus(StatusEnum.ACTIVE, userSubscriptionModel.getSubscriptionVariant().getPlanType(), userSubscriptionModel.getPrice(), null, false));
                        userSubscriptionModel.setSsoCommunicated(false);
                        userSubscriptionModel.setStatusPublished(false);
                        subscriptionService.saveUserSubscription(userSubscriptionModel, false, EventEnum.USER_SUBSCRIPTION_ACTIVE, true, true);
